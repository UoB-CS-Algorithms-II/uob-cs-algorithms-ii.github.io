...
Your mark for the algorithms half of the unit will be split into two parts. 10% (so 5% of the unit) will come from Blackboard quizzes, which are called "Sequence of portfolio submissions" on eVision. The remaining 90% (so 45% of the unit) will come from an exam in December. The two parts together form a "must-pass component" of the unit, so you need to get at least 40% of the available marks in the algorithms half of the unit in order to pass Algorithms and Data as a whole.

## Blackboard quizzes

* There are 10 quizzes in total, one per week, and they are equally weighted (so each quiz counts for 10% of your "portfolio" mark and 0.5% of your unit mark).
* You should get quizzes done before the problem class on that week's material, i.e. by the following Friday morning. University standard late penalties will apply to any quizzes not completed by noon on Monday of week 24. (You can apply for extensions to this deadline through the school office as normal.)
...
* The quizzes are hosted on Blackboard. They are linked from the table in the [main hub](../), or you can see them all in the Blackboard Quizzes "collection" (ugh) on the unit Blackboard page [here](https://www.ole.bris.ac.uk/ultra/courses/_264162_1/outline) (login required).
* There is a dummy quiz available [here](https://www.ole.bris.ac.uk/ultra/courses/_264162_1/outline/assessment/test/_10087403_1?courseId=_264162_1&gradeitemView=details) which is worth no credit, is completely optional, and has no educational value. Take it if you want to make sure that Blackboard quizzes work well on your browser. 
...
* The exam will be divided into two sections. 
   * The first section will contain short-answer questions worth a total of 75 marks, in a similar format to the Blackboard quizzes. For these questions, you won't need to show any working, and any working you do show won't be taken into account --- you'll just need to choose an option, fill in blanks, write down a number, or give some similarly short answer. If you do include working, it's important that you circle your final answer or otherwise make it very clear what it is. 
